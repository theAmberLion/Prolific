...
## For newer versions of cables (usually black ones)

use v3.8.38.2 driver: 
Extract the contents of cab file into a folder. Use **Update driver** button, **Have disk..**, then choose the folder.

---

## For older version of ) of PL2303 cables (usually gray ones

use v3.3.2.105: 
Install the exe, then use **Update driver** button, choose year 2008 driver.
